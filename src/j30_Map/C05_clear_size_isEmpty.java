...
public class C05_clear_size_isEmpty {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("hm.size() clear öncesi = " + hm.size());// 6
        System.out.println("hm.isEmpty() clear öncesi  = " + hm.isEmpty());// false
        hm.clear();
        System.out.println("hm.size() clear sonrası= " + hm.size());// 0
        System.out.println("hm.isEmpty() clear sonrası= " + hm.isEmpty());// true
    }
