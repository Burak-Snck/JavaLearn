...
public class hocaarrays {
    public static void main(String[] args) {
        ...
        System.out.println("sortingen öncesi arr = " + Arrays.toString(isimArr));// sortingen öncesi arr = [Muhammed, Sebnem, Musa, Ayse, Sennur, Recep]
        Arrays.sort(isimArr);// arr NO yapıldı
        System.out.println("sortingen sonrası arr = " + Arrays.toString(isimArr));// sortingen sonrası arr = [Ayse, Muhammed, Musa, Recep, Sebnem, Sennur]
        System.out.println("sortingen öncesi arr = " + Arrays.toString(sayiArr));// sortingen öncesi arr =[42, 0, 0, 54, 54]
        Arrays.sort(sayiArr);// arr NO yapıldı
        System.out.println("sortingen sonrası arr = " + Arrays.toString(sayiArr));// sortingen sonrası arr =[0, 0, 42, 54, 54]
    }
}
