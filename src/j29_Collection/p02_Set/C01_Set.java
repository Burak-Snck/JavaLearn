...
import Denemesayfası.Tasksolution.AracRunner;
...
/*
    ...
    public static void main(String[] args) {
      //  HashSet<String >hs1=new HashSet<String>();
        ...
        HashSet<String> hs2=new HashSet<>(Arrays.asList
                ("javaCAN","javaSU","javaHAN","javaNAZ","javaZADE","javvaNUR","javiDAN","javFER"));


        System.out.println(hs2);
hs2.add("javiye");
        System.out.println(hs2);
        //sete e tekrarlı eleman ekleme

        hs2.add("javaNaz");
        System.out.println(hs2);//tekrarlı ekleme sonrası üzerine yazar //[javvaNUR, javaNAZ, javaNaz, javaHAN, javaCAN, javiye, javaSU, javFER, javiDAN, javaZADE]
        hs2.add(null);
        hs2.add(null);
        hs2.add(null);
        hs2.add(null);
        System.out.println(hs2);//[null, javvaNUR, javaNAZ, javaNaz, javaHAN, javaCAN, javiye, javaSU, javFER, javiDAN, javaZADE]
        HashSet<String> hs3 = new HashSet(Arrays.asList
                ("balcanKebap", "Cüger", "haşhaşKebap", "guzuGerdan", "incik", "küşşşleme"));
     hs2.addAll(hs3);
        System.out.println(hs2);
        ...
        hs2.clear();
        System.out.println(hs2.size());
        //set contains() elemanın varlığı control
        System.out.println(hs3.contains("cüğer"));
        System.out.println(hs2.hashCode());//eleman olmazsa hashcod 0 çıkar
        // set retainAll() elemanlardan kesişen

        HashSet<Integer>hs5=new HashSet<Integer>(Arrays.asList(14,45,67,45,33));
        HashSet<Integer>hs6=new HashSet<Integer>(Arrays.asList(14,47,69,49,33));
