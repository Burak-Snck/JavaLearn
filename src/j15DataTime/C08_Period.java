...
public class C08_Period {
    public static void main(String[] args) {
        ...
        // 2 tarih arasında geçen tekrarlaran datayı tutar...
        LocalDate bugsun=LocalDate.now();
        LocalDate mstf=LocalDate.of(1985,5,17);

        Period p1 =Period.between(bugsun,mstf);//P-38Y-5M-23D
        ...
        Period ps1 = Period.between(bugun, mstfBey);
        ...
        System.out.println("bugun.plus(ebikGabık) = " + bugun.plus(ebikGabık));//2023.11.09 + 4ay+33 gun =? 2023-12-12
