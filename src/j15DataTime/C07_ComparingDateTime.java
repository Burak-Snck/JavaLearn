...
public class C07_ComparingDateTime {
    public static void main(String[] args) {
        ...
        LocalDate feşmekangub = falangun.minusDays(66);
        LocalDate mstf = LocalDate.of(1985, 5, 17);
        System.out.println(bugun);
        System.out.println(falangun);
        System.out.println(feşmekangub);
        System.out.println(mstf);
        System.out.println(falangun.isLeapYear());
        System.out.println(mstf.isBefore(feşmekangub));

        System.out.println(bugun.compareTo(mstf));
        LocalDate bugua = LocalDate.now();
        LocalDate falanGun = bugun.plusDays(33);
